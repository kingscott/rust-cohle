...
- **Next goal:** Week 4 — `rc list` — pretty-print the chapter list to stdout using clap for CLI parsing
- **Blockers:** None
...
- [x] **W3** — Create `data/curriculum.json` with both books' chapters; deserialize with serde in `curriculum.rs`
